...
public class TelaQuartoRE extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaQuartoRE frame = new TelaQuartoRE();
	...
	public TelaQuartoRE() {
		...
		btnAlocarQuarto.setEnabled(false);
		...
		JLabel lblCliente = new JLabel("Cliente - Coloque seu CPF");
		lblCliente.setBounds(10, 78, 143, 14);
		panel_1.add(lblCliente);
		
		textCliente = new JTextField();
		textCliente.setBounds(10, 103, 239, 24);
